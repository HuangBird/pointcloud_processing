...
"""autogenerated by genpy from pcd_reader/read_pcdRequest.msg. Do not edit."""
import sys
...
class read_pcdRequest(genpy.Message):
  ...
  _type = "pcd_reader/read_pcdRequest"
...
def _get_struct_I():
    ...
    return _struct_I
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from pcd_reader/read_pcdResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct
...
class read_pcdResponse(genpy.Message):
  ...
  _type = "pcd_reader/read_pcdResponse"
  _has_header = False #flag to mark the presence of a Header object
...
class read_pcd(object):
  _type          = 'pcd_reader/read_pcd'
  _md5sum = '56f1a0fa28ead46b41096319b59f0aa2'
