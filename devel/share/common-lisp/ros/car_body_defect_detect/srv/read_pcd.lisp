...
(cl:defmethod cl:initialize-instance :after ((m <read_pcd-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'read_pcd-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name car_body_defect_detect-srv:<read_pcd-request> is deprecated: use car_body_defect_detect-srv:read_pcd-request instead.")))

(cl:ensure-generic-function 'file_name-val :lambda-list '(m))
(cl:defmethod file_name-val ((m <read_pcd-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader car_body_defect_detect-srv:file_name-val is deprecated.  Use car_body_defect_detect-srv:file_name instead.")
  (file_name m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<read_pcd-request>)))
  ...
  "car_body_defect_detect/read_pcdRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'read_pcd-request)))
  "Returns string type for a service object of type 'read_pcd-request"
  "car_body_defect_detect/read_pcdRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <read_pcd-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'read_pcd-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name car_body_defect_detect-srv:<read_pcd-response> is deprecated: use car_body_defect_detect-srv:read_pcd-response instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<read_pcd-response>)))
  ...
  "car_body_defect_detect/read_pcdResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'read_pcd-response)))
  "Returns string type for a service object of type 'read_pcd-response"
  "car_body_defect_detect/read_pcdResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'read_pcd)))
  ...
  "car_body_defect_detect/read_pcd")