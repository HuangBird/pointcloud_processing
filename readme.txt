...
function:This node read the pcd file through its service:read_pcd, and publish the point cloud readed and the type of the point cloud (e.g. with normals? with color? etc...) to the topic: inital_point_clouds
...
function:This service is offered by pcd_reader, in this service we can input the name of the file needed to be read
